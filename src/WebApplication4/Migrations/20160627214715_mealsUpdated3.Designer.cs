...
namespace WebApplication4.Migrations
{
    ...
    [Migration("20160627214715_mealsUpdated3")]
    partial class mealsUpdated3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebApplication4.Models.Meal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplication4.Models.FoodCalculator", b =>
                {
                    b.HasOne("WebApplication4.Models.Meal")
                        .WithMany()
